...
// Create effort joint interface as JointA accepts effort command.
    hardware_interface::JointHandle jointEffortHandleA(jointStateHandleA, &joint_position_command_[0]);
    position_joint_interface_.registerHandle(jointEffortHandleA); 
...
// Create effort joint interface as JointB accepts effort command..
    hardware_interface::JointHandle jointEffortHandleB(jointStateHandleB, &joint_position_command_[1]);
    position_joint_interface_.registerHandle(jointEffortHandleB);
...
void MyRobot::read(){
  ...
  joint_position_[1] =2.0;
  joint_position_[2] =6.0;
